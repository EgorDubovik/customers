                    ...
                    <div class="card">
                            ...
                            <div class="row">
                                ...
                                @if (isset($customer))
                                    ...
                                    <div class="customer-view-info" style="display: block">
                                        ...
                                        <p class="fs-18 fw-semibold mb-0"><span
                                                id="customer-card-name">{{ $customer->name }}</span></p>
                                        <span class="text-muted" id="customer-card-email"
                                ...
                                @else
                                    <div class="customer-view-info" style="display: none">
                                        <div class="customer-icon"><i class="fe fe-bookmark"></i></div>
                                        <p class="fs-18 fw-semibold mb-0"><span id="customer-card-name">Customer Name</span>
                                        </p>
                                        <span class="text-muted" id="customer-card-email"
                                            style="font-weight: normal">yourdomain@example.com</span>
                                        <div class="hr"></div>
                                        <input type="hidden" name="customer_address" id="input-customer-address">
                                        <address style="margin-top: 10px;" id="customer-card-address">
                                            Street Address<br>
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" class="form-control customer_name"
                                                    onblur="update_invoice_view()" id="customer_name"
                                                    placeholder="Customer Full Name" name="customer_name"
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" class="form-control customer_phone"
                                                    ...
                                                    onblur="update_invoice_view()" name="email"
                                                    value="{!! isset($customer) ? $customer->email : '' !!}">
                                            </div>
                                        </div>
                                    </div>

                                    <div class="category-create-address">Address <a href="#" class="parse_btn"
                                            onclick="$('.parse_address').toggle(); return false;">parse</a></div>

                                    <textarea name="parse_address" style="display: none" class="parse_address form-control mb-2"
                                        onblur="parse_my_address(this)"></textarea>
                                    <div style="margin-left: 20px;">
                                        <div class="row mb-4">
                        ...
                        <div class="card-footer text-end customer-card-footer" {!! isset($customer) ? "style='display:none'" : '' !!}>
                            <button class="btn btn-primary btn-sm"
                                onclick="save_customer_information();return false;">Save</button>
                        </div>
                                ...
                                @if (isset($appointment))
                                    @foreach ($appointment->services as $service)
                                        <div class="col-sm-12 col-md-6 mb-2">
                                            <input type="hidden" name="service-prices[]" class="service-prices"
                                                value="{{ $service->price }}">
                                            <input type="hidden" name="service-title[]" class="service-title"
                                                value="{{ $service->title }}">
                                            <input type="hidden" name="service-description[]"
                                                class="service-description" value="{{ $service->description }}">
                                            <div class="cont-service-block">
                                                ...
                                                <div class="row mt-2">
                                                    ...
                                                    <div class="col-3">
                                                        <p class="text-end">
                                                            <a href="#"
                                                                onclick="removeServiceItem(this); return false;"
                                                                class=" text-danger">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row pt-5">
                                <div class="col-lg-6">
                                    ...
                                    @else
                                        <p class="fs-18 fw-semibold mb-0"><span id="invoice-customer-name">Customer
                                                Name</span></p>
                                        <address>
    ...
    <script>
        ...
        function addService() {
            ...
            $('#line-services-added').append(
                ...
                '<input type="hidden" name="service-description[]" class = "service-description"  value="' +
                description + '">' +
                '<div class="cont-service-block">' +
                '<div class="row mb-2">' +
